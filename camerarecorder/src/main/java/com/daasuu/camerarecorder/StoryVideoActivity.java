...
public class StoryVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isSeen=ar[4];
        if(Objects.equals(isSeen, "0"))
        {
            findViewById(R.id.story_zoption).setVisibility(View.GONE);
        }
        ...
        String sv=ar[0];
        String tolink="empty";
        if(sv.contains("https")) {
            tolink=sv;
            ScreenDensity(video_height,tolink);
        }
        else{
            tolink="https://s3.ap-south-1.amazonaws.com/toastergifs/"+sv+"_story.mp4";
            ScreenDensity(video_height,tolink);
        }
